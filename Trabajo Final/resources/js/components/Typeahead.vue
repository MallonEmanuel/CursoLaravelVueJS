<!-- https://github.com/codekerala/typeahead-component -->
<template>
        ...
        computed: {
            ...
            filteredOptions() {
                ...
                return this.options.filter((option) => {
                    // return ( exp.test(option.nombre) || exp.test(option.apellido))
                    return ( exp.test(option["nombre"]+" "+option["apellido"]))
                })
            },
            getText(){
                // console.log(mquery.nombre);
            }
        },
        methods: {
            onDownKey() {
            ...
            select(option) {
                this.displayText = option.nombre+" "+option.apellido,
